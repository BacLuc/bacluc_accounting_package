<?php
namespace Concrete\Package\BaclucAccountingPackage;
...
{
    protected $pkgHandle = 'bacluc_accounting_package';
    ...
    {
        return t("Bacluc Accounting Package");
    }
    public function getPackageDescription()
    {
        return t("Package to add Accounting Capabilities to Concrete5");
    }
    public function install()
    {
        ...
        if (!is_object($pre_pkg)){
            throw new Exception (t('To Install BaclucAccountingPackage, you have to Install BaclucPersonPackage first.
            @see <a href=\'https://github.com/BacLuc/basic_table_package\'>https://github.com/BacLuc/bacluc_person_package</a>'));
        }
        ...
        try {
            ...
            $pkg = parent::install();
            //add blocktypeset
            if (!BlockTypeSet::getByHandle('bacluc_accounting_set')) {
            ...
            BlockType::installBlockType("bacluc_configured_move_block", $pkg);
